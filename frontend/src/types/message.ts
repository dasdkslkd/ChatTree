...
export interface StreamChunk {
  ...
  event_type?: 'text' | 'reasoning' | 'process_content' | 'tool_calls_committed' | 'tool_call_start' | 'tool_call' | 'tool_progress' | 'tool_result_delta' | 'tool_call_error' | 'tool_result' | 'tool_approval_request' | 'tool_approval_result';
