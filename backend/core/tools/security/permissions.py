...
def default_permission_rules() -> List[PermissionRule]:
    return [
        ...
        PermissionRule("default-allow-wait-terminal", "allow", "tool", "wait_terminal", source="default"),
        PermissionRule("default-allow-read-terminal", "allow", "tool", "read_terminal", source="default"),
        PermissionRule("default-allow-stop-terminal", "allow", "tool", "stop_terminal", source="default"),
        ...
        PermissionRule("default-ask-start-command", "ask", "tool", "start_command", source="default"),
        PermissionRule("default-ask-start-terminal", "ask", "tool", "start_terminal", source="default"),
