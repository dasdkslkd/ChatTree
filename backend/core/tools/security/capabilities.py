...
DEFAULT_TOOL_CAPABILITIES: Mapping[str, Set[ToolCapability]] = {
    ...
    "start_background_command": {ToolCapability.COMMAND_EXEC},
    "start_command": {ToolCapability.COMMAND_EXEC},
    "read_command": {ToolCapability.READ_ONLY},
    "wait_command": {ToolCapability.READ_ONLY},
    "stop_command": {ToolCapability.COMMAND_EXEC},
    "start_terminal": {ToolCapability.COMMAND_EXEC},
    "read_terminal": {ToolCapability.READ_ONLY},
    "wait_terminal": {ToolCapability.READ_ONLY},
    "stop_terminal": {ToolCapability.COMMAND_EXEC},
